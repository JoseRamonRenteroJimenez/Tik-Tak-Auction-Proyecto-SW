...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-03-2023 a las 18:15:22
...
CREATE TABLE `subastas` (
  ...
  `estado` enum('activa','cerrada','borrador') DEFAULT NULL,
  `imagen` varchar(255) DEFAULT NULL,
  `categoria` varchar(255) DEFAULT NULL,
  `estadoproducto` enum('nuevo','usado','para piezas') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'admin', 'Administrador', 'Admin@example.com', '$2y$10$O3c1kBFa2yDK5F47IUqusOJmIANjHP6EiPyke5dD18ldJEow.e0eS', '2023-03-15 18:14:54'),
(2, 'particular', 'particular', 'particular@example.com', '$2y$10$uM6NtF.f6e.1Ffu2rMWYV.j.X8lhWq9l8PwJcs9/ioVKTGqink6DG', '2023-03-15 18:14:54'),
(3, 'Empresa', 'Empresa', 'Empresa@example.com', '$2y$10$uM6NtF.f6e.1Ffu2rMWYV.j.X8lhWq9l8PwJcs9/ioVKTGqink6DG', '2023-03-15 18:14:54');
